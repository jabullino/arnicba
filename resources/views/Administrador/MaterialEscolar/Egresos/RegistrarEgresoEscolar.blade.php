            ...
            <div class="col-12 col-lg-10">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('EgresosEscolar.store') }}" id="formEgreso">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="destinatario" id="destinatario" class="form-control">
                                    <option value="0">Escoja un destinatario</option>
                            ...
                            <div id="infoProducto" class="alert alert-info" style="display:none;">
                                ...
                                <div class="row align-items-end g-2">
                                    ...
                                    <div class="col-6 col-md-3">
                                        ...
                                        <input type="number" id="cantidadRetiro" class="form-control" min="1"
                                            placeholder="0">
                                    </div>

                                    <div class="col-12 col-md-3">
                                        <button type="button" id="btnAgregar" class="btn btn-success w-100 mt-2 mt-md-0">
