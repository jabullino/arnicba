            ...
            <div class="col-12 col-xl-10">
                ...
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('IngresoEscolar.update', $ingreso->id) }}">
                            @csrf
                            @method('PUT')
                                    ...
                                    <tbody>
                                        @foreach ($ingreso->detalles as $index => $detalle)
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" name="detalles[{{ $index }}][id]"
                                                        value="{{ $detalle->id }}">

                                                    <input type="number" name="detalles[{{ $index }}][cantidad]"
                                                        class="form-control" value="{{ $detalle->cantidad }}"
                                                ...
                                                <td>
                                                    <input type="number" name="detalles[{{ $index }}][precio]"
                                                        class="form-control" value="{{ $detalle->precio }}" step="0.01"
                                                        required>
                                                </td>
                                                ...
                                                <td>
                                                    <input type="date"
                                                        ...
                                                        class="form-control" value="{{ $detalle->vencimiento }}">
                                                </td>
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-lg text-white" style="background-color:#134e4a;">
                                    ACTUALIZAR INGRESO
                                </button>
                            </div>
