    ...
    <div class="row justify-content-center">
        <div class="col-12 col-xl-10">
            ...
            <div class="card shadow-sm">
                <div class="card-header  bg-teal-900 text-white">
                    <h5 class="mb-0 text-center text-md-start  bg-teal-900">Editar producto</h5>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('ProductoEscolar.update', $producto->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-end gap-2">
                            <a href="{{ route('ProductoEscolar.index') }}" class="btn btn-secondary w-100 w-md-auto">Cancelar</a>
                            <button class=" w-100 w-md-auto  bg-teal-900">Actualizar producto</button>
                        </div>
