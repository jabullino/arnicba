                            ...
                            <div class="row g-3">
                                    ...
                                    <select name="color_id" class="form-control">
                                        ...
                                        @foreach ($colores as $color)
                                            <option value="{{ $color->id }}"
                                                {{ old('color_id', optional($producto->tela)->color_id) == $color->id ? 'selected' : '' }}>
                                                {{ $color->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" step="0.01" name="largo" class="form-control"
                                        value="{{ old('largo', optional($producto->tela)->largo) }}">
                                </div>

                                <div class="col-md-4">
                                    <label>Ancho</label>
                                    <input type="number" step="0.01" name="ancho" class="form-control"
                                        value="{{ old('ancho', optional($producto->tela)->ancho) }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                    ...
                                    <select name="talla_id" class="form-control">
                                        ...
                                        @foreach ($tallas as $talla)
                                            <option value="{{ $talla->id }}"
                                                {{ old('talla_id', optional($producto->vestimenta)->talla_id) == $talla->id ? 'selected' : '' }}>
                                                {{ $talla->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="color_id" class="form-control">
                                        ...
                                        @foreach ($colores as $color)
                                            <option value="{{ $color->id }}"
                                                {{ old('color_id', optional($producto->vestimenta)->color_id) == $color->id ? 'selected' : '' }}>
                                                {{ $color->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="tallazapato_id" class="form-control">
                                        ...
                                        @foreach ($tallazapatos as $t)
                                            <option value="{{ $t->id }}"
                                                {{ old('tallazapato_id', optional($producto->zapato)->talla_id) == $t->id ? 'selected' : '' }}>
                                                {{ $t->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="color_id" class="form-control">
                                        ...
                                        @foreach ($colores as $color)
                                            <option value="{{ $color->id }}"
                                                {{ old('color_id', optional($producto->zapato)->color_id) == $color->id ? 'selected' : '' }}>
                                                {{ $color->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
...
document.getElementById('categoria_id').addEventListener('change', mostrarSecciones);
mostrarSecciones();
</script>
@endsection