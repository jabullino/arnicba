...
@section('content') <div id='principal'> <form action="{{ route('personal.update', $usuario->id) }}" method="POST">
@csrf
@method('PATCH')
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="fec_ingreso" id="fec_ingreso" class="form-control"
                        value="{{ $usuario->fec_ingreso }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="user_cod" id="user_cod" class="form-control"
                        value="{{ $usuario->user_cod }}" required>
                </div>

                <!-- ✅ SELECT CORREGIDO -->
                <div class="mb-3">
                    <label for="tipo_id" class="form-label">Tipo de Personal</label>
                    ...
                    <select name="tipo_id" id="tipo_id" class="form-control">
                        ...
                        @foreach ($tipopersonal as $tipo)
                            <option value="{{ $tipo->id }}"
                                {{ $tipo->id == ($usuario->tipo_id ?? null) ? 'selected' : '' }}>
                                {{ $tipo->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="ultimo_monto" id="ultimo_monto" class="form-control"
                        value="{{ $usuario->ultimo_monto ?? '0.00' }}">
                </div>
