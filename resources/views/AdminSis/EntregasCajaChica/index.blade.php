    ...
    function cargarEntregas() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                tabla += '<thead><tr><th>Fecha de Entrega</th><th>Monto</th><th>Acciones</th></tr></thead><tbody>';

                $.each(response, function(i, entrega) {
                    ...
                    let editarUrl = '/AdminSis/entregascajachicas/' + entrega.id + '/edit';
                    let verUrl = '/AdminSis/entregascajachicas/' + entrega.id;
                    let eliminarUrl = '/AdminSis/entregascajachicas/' + entrega.id;
