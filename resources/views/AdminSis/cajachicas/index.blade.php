...
@section('page_content')
    <div class="card p-3 w-[350px] mx-auto">
        ...
        <a href="{{ route('cajachicas.create') }}" class="btn btn-primary mb-3">
            <i class="fas fa-plus-circle"></i> Nueva Caja Chica
        </a>
            ...
            <tbody>
                @forelse($cajachicas as $caja)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('AdminSis/cajachicas/' . $caja->id . '/edit') }}" class="btn btn-sm btn-warning">
                                Editar
                            </a>

                            <form action="{{ route('cajachicas.destroy', $caja->id) }}" method="POST"
