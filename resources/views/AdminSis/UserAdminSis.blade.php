...
@section('content')
    <div> <!---div principal --->
        <div class='card'>
            ...
            <div class='card-header  bg-sky-900 text-center text-black text-bold'>
                FORMULARIO PARA REGISTRO DEL ADMINISTRADOR DE SISTEMA
            </div>

            <form action="{{ route('AdminSis.RegistraAdminSis') }}" method='POST' enctype="multipart/form-data">
                @csrf
                <div class="card-body grid grid-cols-2 grid-rows-7">
                ...
                <div class='mb-2 form-group'>
                    <button type="submit" style='background-color:#071646; color:white;width:900px'>Registrar</button>
                </div>
