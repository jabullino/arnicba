...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <div class="bg-gray-900 flex justify-center items-center h-screen">
        <!-- Left: Image -->
        <div class="hidden lg:block bg-sky-900 w-[250px] h-[300px] ml-0">
            <img src="{{ asset('imagenes/Logo.svg') }}" alt="">
        </div>
        <!-- Right: Login Form -->
        <div class="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2 ">
            <h1 class="text-2xl font-semibold mb-4 text-white bold">Registro</h1>
            @if(session()->has('CredencialesNoValidas'))
         
            <div class='bg-red-500 text-white bold text-lg text-center rounded'>
        ...
        @endif
                <div class="mb-4">
                    <label for="email" class="block text-white" autocomplete="off">Email</label>
                ...
                <!-- Login Button -->
                <button type="submit"
                    class="bg-sky-900 hover:bg-sky-700 text-white font-semibold rounded-md py-2 px-4 w-full">Registrarse</button>
