...
class ImpresionIngresosEgresosEscolarController extends Controller
{
...
*/
    ...
    public function flujoImpresionIngreso($id, $indice = 0)
    {
        ...
        return view('impresion.pantallaescolar', [
            'id'          => $id,
            'indice'      => $indice,
            'total'       => count($detalles),
            'producto'    => $producto->nombre ?? '',
            'urlImprimir' => route('escolar.impresion.ingreso.imprimir', [
                'id' => $id,
                'indice' => $indice
            ])
        ]);
...
*/
    ...
    public function flujoImpresionEgreso($id, $indice = 0)
    {
        ...
        return view('impresion.pantallaegresoescolar', [
            'id'          => $id,
            'indice'      => $indice,
            'total'       => count($detalles),
            'producto'    => $producto->nombre ?? '',
            'egreso_id'   => $detalle->egreso_id, // ← agregado
            'urlImprimir' => route('escolar.impresion.egreso.imprimir', [
                'id' => $id,
                'indice' => $indice
            ])
        ]);
